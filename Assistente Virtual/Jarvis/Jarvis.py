...
def comp():
    speak("Eu sou jarvis, diga-me mestre, o que precisa ?")
    ...
    def JARVIS(self):
        ...
        # if 1:
            ...
            if 'boa noite' in query: #Boa Noite J.A.R.V.I.S
                ...
                speak('meu nome é jarvis, oque deseja senhor ?')

            elif 'teu nome' in query:
                speak('meu nome é jarvis, oque deseja senhor ?')

            elif 'significado de jarvis' in query:
                speak('jarvis significa: eu disse que ia terminar herói.') 
                ...
                speak('Assim como o edith sou uma inteligência artificial, criada com tecnologia Stark!')
...
class Janela (QMainWindow):
    def __init__(self):
        ...
        self.movie = QMovie("/home/andre/Jarvis/imagem/JARVIS.gif")
        ...
        botao_fechar.setStyleSheet("background-image : url(/home/andre/Jarvis/imagem/fechar.png);border-radius: 15px") 
    ...
    def CarregarJanela(self):
        ...
        self.setWindowIcon(QtGui.QIcon('/home/andre/Jarvis/imagem/icone.png'))
